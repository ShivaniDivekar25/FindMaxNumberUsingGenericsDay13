...
namespace GenericsFindMaxNumDay10
{
    ...
    {
        public static void maxNumber()          //Creating method to find maximum number using CompareTo method
        {
            int a = 45;
            int b = 60;
            int c = 20;
        ...
        public static void maxNumber1()         //Creating method to find maximum number using CompareTo method
        {
            float a = 11.34f;
            float b = 45.96f;
            float c = 75.74f;
